...
from model.data_loader import get_loaders
from model.trainer import Trainer

from model.models.fc_model import FullyConnectedClassifier
from model.models.cnn_model import ConvolutionalClassifier
...
def get_model(config):
    if config.model == 'fc':
        ...
        model = ConvolutionalClassifier(1)
    else:
